...
model ActivePowerModeMMCstation
  "MMC HVDC station with only active power control."
...
public
  ...
  Modelica.Blocks.Math.Gain gain(k=MVAb)
                                        annotation (
    Placement(visible = true, transformation(origin={16,-160},      extent={{-6,-6},
            {6,6}},                                                                                  rotation=0)));
  Modelica.Blocks.Interfaces.RealOutput Pref_SI
    "Reference AC Active Power (MW)" annotation (Placement(transformation(
        extent={{-9,-9},{9,9}},
        rotation=0,
        origin={45,-169}), iconTransformation(
        extent={{-9,-9},{9,9}},
        rotation=270,
        origin={187,-109})));
...
equation
  ...
  connect(powerControl.igd_ref,aCside_R_Modulation.igd_ref)  annotation (Line(
        points={{-18,-40},{96,-40}},                              color={0,0,127}));
  connect(reactivePowerControl.igq_ref,aCside_I_Modulation.igq_ref)
    annotation (Line(points={{-18,-100},{96,-100}},
        color={0,0,127}));
  ...
  connect(dCvoltageSquareReference.Wtot, energy_Calculator.Wtot)
    annotation (Line(points={{-103.333,20},{-138.4,20}},
        color={0,0,127}));
  ...
  connect(dq_to_RI.xi, pu_to_SI.Vmi_pu) annotation (Line(points={{178.82,57.14},
          {178.82,70},{138.3,70},{138.3,79}},
                                            color={0,0,127}));
  connect(aCside_R_Modulation.Vmd, dq_to_RI.xd) annotation (Line(points={{142,-40},
          {172.76,-40},{172.76,42.8}},          color={0,0,127}));
  connect(aCside_I_Modulation.Vmq, dq_to_RI.xq) annotation (Line(points={{142,
  ...
  connect(gain.u, Pref)
    annotation (Line(points={{8.8,-160},{0,-160},{0,-200}},  color={0,0,127}));
  ...
  connect(gain.y, Pref_SI) annotation (Line(points={{22.6,-160},{30,-160},{30,
          -169},{45,-169}}, color={0,0,127}));
  connect(dCvoltageSquareReference.idc_ref, dCsideModulation.idc_ref)
    annotation (Line(points={{-58.3333,20},{96,20}}, color={0,0,127}));
  ...
  connect(pQ_calculator.vgq, rI_to_dq.xq) annotation (Line(points={{-163.4,
          ...
          127}));
  connect(powerControl.Pac_ref, Pref) annotation (Line(points={{-64,-28},{-88,
          -28},{-88,-160},{0,-160},{0,-200}}, color={0,0,127}));
  connect(reactivePowerControl.Qac_ref, Qref) annotation (Line(points={{-64,-88},
          {-80,-88},{-80,-140},{100,-140},{100,-200}}, color={0,0,127}));
  connect(reactivePowerControl.Qac, pQ_calculator.Qac) annotation (Line(points=
          {{-64,-100},{-106,-100},{-106,-54},{-116.8,-54}}, color={0,0,127}));
  connect(pQ_calculator.Pac, powerControl.Pac) annotation (Line(points={{-116.8,
          -38.8},{-64,-38.8},{-64,-40}}, color={0,0,127}));
  connect(dCvoltageSquareReference.Pac, pQ_calculator.Pac) annotation (Line(
        points={{-103.333,7.6},{-110,7.6},{-110,-38.8},{-116.8,-38.8}}, color={
          0,0,127}));
  connect(sI_to_pu.Idc_pu, dCsideModulation.idc) annotation (Line(points={{
  ...
  connect(energy_Calculator.Vceq, sI_to_pu.Vceq_pu) annotation (Line(points={{
          ...
          127}));
  connect(aCside_I_Modulation.vgq, rI_to_dq.xq) annotation (Line(points={{96,
          -92},{-8,-92},{-8,-74},{-92,-74},{-92,-6},{-16.1,-6},{-16.1,38.29}},
        color={0,0,127}));
  connect(powerControl.Vgd, rI_to_dq.xd) annotation (Line(points={{-64,-52},{
  ...
  connect(reactivePowerControl.Vgd, rI_to_dq.xd) annotation (Line(points={{-64,
          ...
          127}));
  connect(aCside_R_Modulation.vgd, rI_to_dq.xd) annotation (Line(points={{96,
          -32},{-8,-32},{-8,-66},{-100,-66},{-100,-10},{-28.1,-10},{-28.1,38.29}},
        color={0,0,127}));
  connect(aCside_R_Modulation.igd, rI_to_dq1.xd) annotation (Line(points={{96,
  ...
  connect(aCside_I_Modulation.igd, rI_to_dq1.xd) annotation (Line(points={{96,
          -116},{0,-116},{0,-18},{-0.1,-18},{-0.1,38.29}}, color={0,0,127}));
  connect(sI_to_pu.Vceq_pu, aCside_R_Modulation.Vc_eq) annotation (Line(points=
          {{-43.1,76},{-43.1,-4},{60,-4},{60,-64},{96,-64}}, color={0,0,127}));
  connect(aCside_I_Modulation.Vc_eq, sI_to_pu.Vceq_pu) annotation (Line(points=
          {{96,-124},{60,-124},{60,-4},{-43.1,-4},{-43.1,76}}, color={0,0,127}));
