...
model MasterHVDCstationWithoutBlocking
  "This is the user configurable master station where user can define the mode of operation among Pac-Qac, Vdc-Qac, and Vac modes dynamically."
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-200,
        ...
        coordinateSystem(preserveAspectRatio=false, extent={{-200,-240},{200,
            240}},
        grid={2,2})));
end MasterHVDCstationWithoutBlocking;
